...
REQUIREMENTS = ['https://github.com/Teagan42/sleepyq/archive/'
                '963e307657e53805308fb25f0c5e1ebfdb0c3fa2.zip'
                '#sleepyq==index_patch']
...
class SleepIQSensor(Entity):
    ...
    def update(self):
        ...
        _LOGGER.error('IQ Bed: ' + str(self.bed.__dict__))
        self.side = getattr(self.bed, self._side)
        _LOGGER.error('IQ Side :: ' + str(self.side.__dict__))
        _LOGGER.error('IQ Sleeper :: ' + str(self.side.sleeper.__dict__))
